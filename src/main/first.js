        ...
        <>
            <main>
                <div className='relative'>
                    <svg width="393" height="532" viewBox="0 0 393 532" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <img className='inner-place top-80' src='/images/DJV_MAR_1034_02_removebg_preview.png' alt='img' />
                </div>
            </main>
            <footer>
